...
class GenerateGraph:
    ...
    def generate_graph_vaccine_status(self):
        ...
        self.save_image_to_blob_storage(self.blob_client_obj_vaccine_status, image_object)
    ...
    def generate_graph_vaccination_name(self):
        ...
        self.save_image_to_blob_storage(self.blob_client_obj_vaccine_name, image_object)
